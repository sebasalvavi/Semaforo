...
const int8_t boton1 = 8;
const int8_t boton2 = 9;
const int8_t led_G = 7;
const int8_t led_Y = 5;
const int8_t led_R = 6;

const int intervalo = 400;         //Constante para que los cambios de velocidad y estado no se salten valore
...
Estado_Semaforo semaforo_act(){
  ...
  uart_antirebote(tecla1.tecla,  tecla1.estadob);
  uart_antirebote(tecla2.tecla,  tecla2.estadob);
